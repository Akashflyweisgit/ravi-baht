  ...
  return (
    <div className="homepage">
      ...
      <div className="active">
        <div className="activeText">Total Active Users</div>
      </div>
      <div className="activeCount">
        <div className="activeNumber">55 </div>
      </div>
      <div className="hours">
        <div className="hoursText">Last 48 Hours SignUp</div>
      </div>
      ...
      <div className="logIn">
        <div className="logInText">Last 48 Hours Logged in Users</div>
      </div>
      ...
      <div className="newUser">
        ...
        <div className="newUserText">Add New User</div>
      </div>
